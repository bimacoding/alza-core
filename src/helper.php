...
use Alza\Container\Container as Container;
...
if (!function_exists('app')) {
     ...
     *
     * @return mixed|\Alza\Kernel\Application
     * @throws
     */
...
if (!function_exists('abort')) {
    ...
    {
        if ($code === 404) {
            throw new \Alza\Exception\NotFoundHttpException($message);
        }

        throw new \Alza\Exception\HttpException($code, $message, null, $headers);
    }
}
...
if (!function_exists('auth')) {
     ...
     * Authentication
     *
     * @return Alza\Auth\Auth
     */
    function auth(): Alza\Auth\Auth
    {
        /** @var \Alza\Auth\Auth $auth */
        return app(\Alza\Auth\Auth::class);
    }
}
...
if (!function_exists('admin')) {
     ...
     * @throws
     */
    function admin(): \Alza\Auth\Auth
    {
        return app()->makeWith(\Alza\Auth\Auth::class, ['prefix' => 'admin']);
    }
}
...
if (!function_exists('session')) {
     ...
     *
     * @return Alza\Http\Session|string|array|int
     */
    function session(?string $name = null)
    {
        /** @var \Alza\Http\Session $session */
        $session = app(\Alza\Http\Session::class);
        if (is_null($name)) {
            return $session;
        }
...
if (!function_exists('cookie')) {
     ...
     * @param string|null $name
     *
     * @return Alza\Http\Cookie|string|int
     */
    function cookie(?string $name = null)
    {
        /** @var \Alza\Http\Cookie $cookie */
        $cookie = app(\Alza\Http\Cookie::class);
        if (is_null($name)) {
            return $cookie;
        }
...
if (!function_exists('event')) {
    ...
    {
        return app(\Alza\Event\Event::class)->trigger($event, $params, $method);
    }
}
...
if (!function_exists('bcrypt')) {
     ...
     * @param array       $options
     *
     * @return string|\Alza\Hash\BcryptHash
     */
...
if (!function_exists('csrf_token')) {
    ...
    function csrf_token(?string $name = null): string
    {
        ...
        session()->set('_alza_csrf' . (!is_null($name) ? '_' . $name : ''), $csrf);
...
if (!function_exists('csrf_check')) {
    ...
    function csrf_check(string $token, $name = null): bool
    {
        ...
        if (session()->has('_alza_csrf' . $name) &&
            $token === session()->get('_alza_csrf' . $name)) {
            session()->delete('_alza_csrf' . $name);
            return true;
        }
...
if (!function_exists('request')) {
     ...
     * @param mixed        $default
     *
     * @return \Alza\Http\Request|string|array
     */
    function request($key = null, $default = null)
    {
        $request = app(\Alza\Http\Request::class);
        if (is_null($key)) {
            return $request;
        }
        if (is_array($key)) {
...
if (!function_exists('response')) {
    ...
    {
        if (func_num_args() === 0) {
            return app(\Alza\Http\Response::class);
        }

        return app()->make(\Alza\Http\Response::class, [
            'content' => $content,
            'status' => $status,
            'headers' => $headers,
        ]);
...
if (!function_exists('validation')) {
     ...
     *
     * @return \Alza\Http\Validation
     */
    function validation()
    {
        return app(\Alza\Http\Validation::class);
    }
}
...
if (!function_exists('trans')) {
     ...
     *
     * @return \Alza\Translation\Translator|string|array|null
     */
    function trans(?string $key = null, $replace = [], $locale = null)
    {
        /** @var \Alza\Translation\Translator $translator */
