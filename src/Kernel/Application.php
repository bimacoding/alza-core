...
use Alza\Container\Container;
use Alza\Exception\ExceptionHandler;
...
class Application extends Container
{
    ...
    /**
     * The base path for the Alza Framework installation.
     *
     * @var string
     */
    protected $basePath;
    ...
    /**
     * Create a new Alza application instance.
     *
     * @return void
     */
    ...
    public function start(string $env): void
    {
        ...
        ini_set('error_log', $this->storagePath('log/alza.log'));
    ...
    /**
     * Get the base path of the Alza Framework installation.
     *
    ...
    public function registerConfiguredProviders(): void
    {
        $providers = Collection::make($this->config['app.providers'])
            ->partition(function ($provider) {
                return Str::startsWith($provider, 'Alza\\');
            });
    ...
    protected function init(): void
    {
        $this->registerCoreProviders = [
            \Alza\Providers\Event::class,
            \Alza\Providers\Request::class,
            \Alza\Providers\Response::class,
            \Alza\Providers\Session::class,
            \Alza\Providers\Cookie::class,
            \Alza\Providers\Route::class,
            \Alza\Providers\Uri::class,
            \Alza\Providers\Load::class,
            \Alza\Providers\Date::class,
            \Alza\Providers\Encryption::class,
            \Alza\Providers\Log::class,
        ];

        $this->registerCoreAliases = [
            'Request'   => \Alza\Facades\Request::class,
            'Response'  => \Alza\Facades\Response::class,
            'Cookie'    => \Alza\Facades\Cookie::class,
            'Session'   => \Alza\Facades\Session::class,
            'Route'     => \Alza\Facades\Route::class,
            'Uri'       => \Alza\Facades\Uri::class,
            'Date'      => \Alza\Facades\Date::class,
            'Log'       => \Alza\Facades\Log::class,
            'Validation'=> \Alza\Facades\Validation::class,
            'File'      => \Alza\Facades\File::class,
        ];
    }
    ...
    protected function registerBaseBindings(): void
    {
        ...
        $this->singleton('config', function () {
            return new \Alza\Config\Config($this->config);
        });
