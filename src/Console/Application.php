...
{
    /**
     * @var \Alza\Console\Application
     */
    protected $app;

    /**
     * @var \Alza\Kernel\Application
     */
    protected $Alza;
     ...
     * @param \Alza\Kernel\Application $app                        Alza Framework Application
     *
     * @return void
     */
    ...
    public function generate()
    {
        ...
        foreach ($this->commandList as $key => $value) {
            $this->app->add(new $value($this->alza));
        }
        ...
        foreach ($this->migrationCommands as $command) {
             ...
             */
            $newCommand = new $command($this->alza);
